...
java_code_cut(input_dir + "train_20.txt", output_dir + "train_surrogate.json", num_lines=2586) # not sure
java_code_cut(input_dir + "test.txt", output_dir + "test_surrogate.json", num_lines=2586)
