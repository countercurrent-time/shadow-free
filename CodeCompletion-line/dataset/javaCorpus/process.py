...
dir = "../../../CodeCompletion-token/dataset/javaCorpus/"
# classifier: PREDICTION_DATA_FOLDER_PATH=../../CodeCompletion-token/dataset/javaCorpus/${Percentage}/${SAMPLE_RATIO}/

java_code_cut(dir + "token_completion/train.txt", dir + "0.01/20/train_victim.json")
java_code_cut(dir + "token_completion/test.txt", dir + "0.01/20/test_victim.json")
# train_20.txt generated by pipline_java.sh
# SAMPLE_RATIO=20 -> num_lines=2586
java_code_cut(dir + "token_completion/train_20.txt", dir + "0.01/20/train_surrogate.json", num_lines=2586) # not sure
java_code_cut(dir + "token_completion/test.txt", dir + "0.01/20/test_surrogate.json", num_lines=2586)
